    ...
    play(){
       ...
       for(var plr in allPlayers){
        ...
        if(allPlayers.player1.score > allPlayers.player2.score){
            ...
            fill("white");
            text("the winner is " + allPlayers.player1.name, 550,300);
            text("Score of P1 " + allPlayers.player1.score, 550,350);
            text("Score of P2 " + allPlayers.player2.score, 550,400);
            

        }
        else{
            fill("white");
            text("the winner is " + allPlayers.player2.name, 550,300);
            text("Score of P1 " + allPlayers.player1.score, 550,350);
            text("Score of P2 " + allPlayers.player2.score, 550,400);
        }
